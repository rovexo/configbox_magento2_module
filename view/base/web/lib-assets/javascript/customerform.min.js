...
d.find(".trigger-login").trigger("click");0!==c.closest(".recover-box").length&&d.find(".trigger-request-verification-code").trigger("click");0!==c.closest(".change-password-box").length&&d.find(".trigger-change-password").trigger("click")}});a(document).on("change","select.updates-states",function(){a(this).trigger("chosen:updated");let c=parseInt(a(this).val()),d=a(this).data("state-select-id"),b=a("#"+d);0!==b.length&&(0===c?(b.html('<option value="0" selected="selected"></option>'),b.prop("disabled",
...
function(){a(this).trigger("chosen:updated");let c=parseInt(a(this).val()),d=a(this).data("county-select-id"),b=a("#"+d);0!==b.length&&(0===c?(b.html('<option value="0" selected="selected"></option>'),b.prop("disabled",!0),b.trigger("chosen:updated").trigger("change")):cbrequire(["configbox/server"],function(e){e.makeRequest("customerform","getCounties",{state_id:c}).done(function(f){b.html("").prop("disabled",!1);0===f.length?b.closest(".customer-field").addClass("has-no-data"):b.closest(".customer-field").removeClass("has-no-data");
a.each(f,function(h,g){b.append('<option value="'+g.id+'">'+g.county_name+"</option>")});b.trigger("chosen:updated").trigger("change")})}))});a(document).on("change",".view-customerform select.updates-cities",function(){a(this).trigger("chosen:updated");let c=parseInt(a(this).val()),d=a(this).data("city-select-id"),b=a("#"+d);if(0!==b.length)if(0===c){b.val("0").trigger("chosen:updated").trigger("change");b.closest(".customer-field").addClass("uses-textfield-instead");let e=d.replace("_id","");b.closest(".view-customerform").find(".customer-field-"+
e).removeClass("uses-dropdown-instead")}else cbrequire(["configbox/server"],function(e){e.makeRequest("customerform","getCities",{county_id:c}).done(function(f){b.html("").prop("disabled",!1);if(0===f.length)b.val("0").trigger("chosen:updated").trigger("change"),b.closest(".customer-field").addClass("uses-textfield-instead"),f=d.replace("_id",""),b.closest(".view-customerform").find(".customer-field-"+f).removeClass("uses-dropdown-instead");else{b.closest(".customer-field").removeClass("has-no-data uses-textfield-instead");
var h=d.replace("_id","");a("#"+h).val("");b.closest(".view-customerform").find(".customer-field-"+h).addClass("uses-dropdown-instead");a.each(f,function(g,m){b.append('<option value="'+m.id+'">'+m.city_name+"</option>")});b.trigger("change").trigger("chosen:updated")}})})})},getCustomerFormData:function(){let c={};a(".kenedo-view.view-customerform :input").each(function(d,b){d=a(b).attr("name");let e;a(b).attr("name")&&(a(b).is("input[type=radio]")?!0===a(b).prop("checked")&&(e=a(b).val()):e=a(b).is("input[type=checkbox]")?
!0===a(b).prop("checked")?"1":"0":a(b).val(),d&&void 0!==e&&(c[d]=e))});"1"===c.samedelivery&&a.each(c,function(d,b){0===d.indexOf("billing")&&(d=d.substr(7),"undefined"!==typeof c[d]&&(c[d]=b))});return c},displayValidationIssues:function(c){a(".view-customerform .customer-field:visible").removeClass("invalid").addClass("valid");for(let d in c)c.hasOwnProperty(d)&&(a(".customer-field-"+c[d].fieldName).removeClass("valid").addClass("invalid"),a(".customer-field-"+c[d].fieldName).find(".validation-tooltip").data("message",
c[d].message));k.initValidationTooltips()},removeValidationIssues:function(){a(".view-customerform .customer-field:visible").removeClass("invalid").removeClass("valid");a(".view-customerform .validation-tooltip").data("message","");k.initValidationTooltips()},initValidationTooltips:function(){a(".validation-tooltip").each(function(){let c={customClass:"cb-content validation-tooltip",animation:!1,trigger:"hover",html:"undefined"!==typeof a(this).data("html")?a(this).data("html"):!0,content:a(this).data("message")||
""};new l.Popover(a(this).get(0),c)})}};return k});
